 ...
 * File style: the editorial index becomes a restrained atmospheric field, with white mineral particles and emerald hover response.
 * Does this choice reinforce or dilute our design philosophy? Motion stays subtle, spatial, and secondary to the content.
 */
