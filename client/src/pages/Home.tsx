...
function CardNav() {
  ...
  return (
    <header className={`site-nav ${scrolled ? "site-nav--scrolled" : ""}`}>
      ...
      <div className="mobile-staggered-menu"><ReactBitsStaggeredMenu position="right" colors={["#02161b", "#0a3b46", "#2b8fd9"]} items={[{ label: "Surface stories", link: "#stories", ariaLabel: "Go to Surface stories" }, { label: "Services", link: "#services", ariaLabel: "Go to Services" }, { label: "Booking", link: "#booking", ariaLabel: "Go to Booking" }]} socialItems={[{ label: "Call 972-880-9311", link: "tel:+19728809311" }, { label: "WhatsApp 972-880-9311", link: "https://wa.me/19728809311" }, { label: "Instagram", link: "https://www.instagram.com/surfacecraft1/" }, { label: "TikTok", link: "https://www.tiktok.com/@surface.craft" }, { label: "Facebook", link: "https://www.facebook.com/share/14nPfyJ1an6/?mibextid=wwXIfr" }, { label: "Email us", link: "mailto:surfacecraftfrisco@gmail.com" }]} displaySocials displayItemNumbering logoUrl={ASSETS.logo} menuButtonColor="#02080a" openMenuButtonColor="#2b8fd9" accentColor="#2b8fd9" changeMenuColorOnOpen={false} isFixed /></div>
    </header>
  );
}
